...
class UpdateStudent(AddStudent):
    ...
    def create_layout(self):
        ...
        user_id_label = Label(user_id_frame, text="User ID", width=15)
        ...
        student_id_frame = ttk.Frame(modify_wrapper_frame)
        student_id_frame.pack(fill=X)
        student_id_label = Label(student_id_frame, text="Student Number", width=15)
        student_id_label.pack(side=LEFT, padx=10, pady=5)
        self.student_id_entry = Entry(student_id_frame)
        ...
        button_ok = ttk.Button(button_frame, text='Update',
                               command=self.modify_student_data)
    ...
    def modify_student_data(self):
        ...
        try:
            db_operation.admin_view_update_students(
                user_id=user_id,
